...
function anon_function_without_parens_with(env, param) {
  ...
  if (typeof match === "number" && !(match !== 12 || Parser_env$Jeason.no_anon_function_type(env))) {
    ...
    return function_with_params(env, start_loc, /* None */0, params);
  } else {
    return param;
  }
}
...
function primary(env) {
  ...
  switch (exit) {
    ...
    case 2 : 
        var match$4 = Curry._3(_object, /* None */0, /* Some */[true], env);
        return /* tuple */[
                match$4[0],
...
function param_list_or_type(env) {
  Parser_env$Jeason.Expect[/* token */0](env, /* T_LPAREN */5);
  var env$1 = Parser_env$Jeason.with_no_anon_function_type(false, env);
  ...
  while(true) {
    ...
    switch (exit) {
      case 1 : 
          var match;
          var exit$1 = 0;
          if ($$static && !(variance$1 || !(typeof token === "number" && token === 80))) {
...
function _object($staropt$star, $staropt$star$1, env) {
  ...
  var allow_exact = $staropt$star$1 ? $staropt$star$1[0] : false;
...
function wrap(f, env) {
  var env$1 = Parser_env$Jeason.with_strict(true, env);
...
function _object$1($staropt$star, env) {
  var allow_static = $staropt$star ? $staropt$star[0] : false;
  return wrap(Curry._2(_object, /* Some */[allow_static], /* Some */[false]), env);
}
...
function strict_post_check(env, strict, simple, id, param) {
  if (strict || !simple) {
    var rest = param[1];
    var env$1 = strict ? Parser_env$Jeason.with_strict(!Parser_env$Jeason.in_strict_mode(env), env) : env;
    if (id) {
      var match = id[0];
      var name = match[1];
      var loc = match[0];
...
function $$const(env) {
  var env$1 = Parser_env$Jeason.with_no_let(true, env);
...
function conditional(env) {
  ...
  if (Parser_env$Jeason.Peek[/* token */0](/* None */0, env) === /* T_PLING */79) {
    Parser_env$Jeason.Expect[/* token */0](env, /* T_PLING */79);
    var env$prime = Parser_env$Jeason.with_no_in(false, env);
...
function left_hand_side(env) {
  var start_loc = Parser_env$Jeason.Peek[/* loc */2](/* None */0, env);
  var allow_new = !Parser_env$Jeason.no_new(env);
  var env$1 = Parser_env$Jeason.with_no_new(false, env);
  var match = Parser_env$Jeason.Peek[/* token */0](/* None */0, env$1);
  var expr;
  var exit = 0;
...
function new_expression(env) {
  ...
  if (Parser_env$Jeason.in_function(env) && Parser_env$Jeason.Peek[/* token */0](/* None */0, env) === /* T_PERIOD */11) {
    ...
    var callee = member(Parser_env$Jeason.with_no_call(true, env), callee_loc, expr);
    var match$1 = Parser_env$Jeason.Peek[/* token */0](/* None */0, env);
    var callee$1;
...
function member(env, start_loc, left) {
  ...
  if (typeof match === "number") {
    if (match !== 7) {
      ...
      Parser_env$Jeason.Expect[/* token */0](env, /* T_LBRACKET */7);
      var expr = Curry._1(Parse[/* expression */6], Parser_env$Jeason.with_no_call(false, env));
      var last_loc = Parser_env$Jeason.Peek[/* loc */2](/* None */0, env);
      Parser_env$Jeason.Expect[/* token */0](env, /* T_RBRACKET */8);
      var loc$1 = Loc$Jeason.btwn(start_loc, last_loc);
      return call(env, start_loc, /* tuple */[
...
function assignment(env) {
  ...
  if (typeof match === "number") {
    ...
    if (switcher > 85 || switcher < 0) {
      ...
      var has_argument = !(Parser_env$Jeason.Peek[/* token */0](/* None */0, env$1) === /* T_SEMICOLON */9 || Parser_env$Jeason.Peek[/* is_implicit_semicolon */6](env$1));
...
function binary(env) {
  ...
  while(true) {
    ...
    var right = unary(Parser_env$Jeason.with_no_in(false, env$1));
...
function try_arrow_function(env) {
  ...
  if (Parser_env$Jeason.Peek[/* is_identifier */8](/* None */0, env$1) && typeParameters === /* None */0) {
    ...
    var match$2 = wrap(annotation_and_predicate_opt, Parser_env$Jeason.with_no_anon_function_type(true, env$1));
    match = /* tuple */[
      params,
      match$2[0],
      match$2[1]
  ...
  var match$3 = with_loc((function (param) {
          ...
          var async$1 = async;
          var generator = false;
          var env$1 = Parser_env$Jeason.with_in_function(true, env);
          var match = Parser_env$Jeason.Peek[/* token */0](/* None */0, env$1);
          var exit = 0;
...
function key(env) {
  ...
  if (typeof match === "number") {
    if (match === 7) {
      var start_loc = Parser_env$Jeason.Peek[/* loc */2](/* None */0, env);
      Parser_env$Jeason.Expect[/* token */0](env, /* T_LBRACKET */7);
      var expr = Curry._1(Parse[/* assignment */8], Parser_env$Jeason.with_no_in(false, env));
      var end_loc = Parser_env$Jeason.Peek[/* loc */2](/* None */0, env);
      Parser_env$Jeason.Expect[/* token */0](env, /* T_RBRACKET */8);
      return /* tuple */[
              Loc$Jeason.btwn(start_loc, end_loc),
...
function _method(env, kind) {
  ...
  var match$2 = function_body(env, false, generator);
  var body = match$2[1];
  var simple = is_simple_function_params(params);
...
function class_element(env) {
  ...
  var generator$1 = generator || !variance$2 ? generator : Parser_env$Jeason.Expect[/* maybe */1](env, /* T_MULT */100);
  var match = key(env);
  var exit = 0;
...
function _class(env) {
  ...
  if (Parser_env$Jeason.Peek[/* token */0](/* None */0, env) === /* T_EXTENDS */41) {
    ...
    var superClass = left_hand_side(Parser_env$Jeason.with_allow_yield(false, env));
...
function class_declaration(env, decorators) {
  ...
  var tmp_env = Parser_env$Jeason.with_no_let(true, env$1);
  var match = Parser_env$Jeason.in_export(env$1);
  var match$1 = Parser_env$Jeason.Peek[/* is_identifier */8](/* None */0, tmp_env);
  var id = match ? (
      match$1 ? /* Some */[Curry._2(Parse[/* identifier */12], /* None */0, tmp_env)] : /* None */0
...
function declare_export_declaration($staropt$star, env) {
  ...
  var env$1 = Parser_env$Jeason.with_in_export(true, Parser_env$Jeason.with_strict(true, env));
...
function declare_var(env, start_loc) {
  ...
  var match = Curry._3(Parse[/* identifier_with_type */14], env, /* Some */[true], /* StrictVarName */28);
  var match$1 = match[1];
...
function case_list(env, _param) {
  while(true) {
    ...
    if (exit === 1) {
      ...
      var consequent = Curry._2(Parse[/* statement_list */3], term_fn, Parser_env$Jeason.with_in_switch(true, env));
  ...
  if (typeof match === "number") {
    if (match !== 27) {
      if (match !== 28) {
        ...
        var match$1 = helper(Parser_env$Jeason.with_no_let(true, env$1), /* [] */0, /* [] */0);
        ...
        if (match >= 60) {
          ...
          switch (match) {
            ...
            case 25 : 
                ...
                var body$1 = Curry._1(Parse[/* statement */1], Parser_env$Jeason.with_in_loop(true, env$7));
                return /* tuple */[
            ...
            case 37 : 
                ...
                var body$3 = Curry._1(Parse[/* statement */1], Parser_env$Jeason.with_in_loop(true, env$11));
            ...
            case 39 : 
                ...
                if (typeof match$9 === "number") {
                  if (match$9 >= 24) {
                    if (match$9 >= 29) {
                      ...
                      switch (match$9 - 24 | 0) {
                        case 0 : 
                            var match$11 = declarations(/* T_VAR */24, /* Var */0, Parser_env$Jeason.with_no_in(true, env$12));
                            match$10 = /* tuple */[
                        ...
                        case 2 : 
                            ...
                            break;
                        case 3 : 
                            var match$12 = $$const(Parser_env$Jeason.with_no_in(true, env$12));
                            match$10 = /* tuple */[
                            ...
                            break;
                        case 4 : 
                            var match$13 = _let(Parser_env$Jeason.with_no_in(true, env$12));
                            match$10 = /* tuple */[
                ...
                if (exit$2 === 1) {
                  var expr = Curry._1(Parse[/* expression */6], Parser_env$Jeason.with_no_let(true, Parser_env$Jeason.with_no_in(true, env$12)));
                  match$10 = /* tuple */[
                ...
                if (t === /* T_OF */62 || async) {
                  ...
                  var body$4 = Curry._1(Parse[/* statement */1], Parser_env$Jeason.with_in_loop(true, env$12));
                  return /* tuple */[
                  ...
                  Parser_env$Jeason.Expect[/* token */0](env$12, /* T_RPAREN */6);
                  var body$5 = Curry._1(Parse[/* statement */1], Parser_env$Jeason.with_in_loop(true, env$12));
                  return /* tuple */[
                ...
                if (exit$3 === 1) {
                  ...
                  Parser_env$Jeason.Expect[/* token */0](env$12, /* T_RPAREN */6);
                  var body$6 = Curry._1(Parse[/* statement */1], Parser_env$Jeason.with_in_loop(true, env$12));
                  return /* tuple */[
    ...
    if (switcher > 11 || switcher < 0) {
      ...
      switch (switcher) {
        case 0 : 
            var env$1 = env;
            var decorators$1 = decorators;
            var env$2 = Parser_env$Jeason.with_in_export(true, Parser_env$Jeason.with_strict(true, env$1));
        ...
        case 1 : 
            Parser_env$Jeason.error_on_decorators(env)(decorators);
            var env$3 = env;
            var env$4 = Parser_env$Jeason.with_strict(true, env$3);
            var start_loc$1 = Parser_env$Jeason.Peek[/* loc */2](/* None */0, env$4);
...
function identifier_with_type(env, $staropt$star, restricted_error) {
  var no_optional = $staropt$star ? $staropt$star[0] : false;
  return with_loc((function (param) {
                ...
                var optional = !no_optional$1 && Parser_env$Jeason.Peek[/* token */0](/* None */0, env) === /* T_PLING */79;
                if (optional) {
                  if (!Parser_env$Jeason.should_parse_types(env)) {
                    Parser_env$Jeason.error(env, /* UnexpectedTypeAnnotation */7);
                  }
...
function left_hand_side$1(env) {
  var ast = Curry._1(Parse[/* left_hand_side */9], Parser_env$Jeason.with_no_new(true, env));
  Parser_env$Jeason.Expect[/* token */0](env, /* T_EOF */108);
  return ast;
}
...
function jsx_pragma_expression(content, filename) {
  ...
  return do_parse(env, left_hand_side$1, true);
}
