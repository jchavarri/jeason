...
function create(lex_env, mode) {
  ...
  var lex_env$1 = Lexer_flow$Jeason.Lex_env[/* with_lexbuf */4](newrecord, lex_env);
  return /* record */[
          /* la_results : array */[],
          /* la_num_lexed */0,
          /* la_lex_mode */mode,
...
function lex(t) {
  ...
  var newrecord = lexbuf.slice();
  newrecord[/* lex_buffer */1] = lexbuf[/* lex_buffer */1];
  var cloned_env = Lexer_flow$Jeason.Lex_env[/* with_lexbuf */4](newrecord, lex_env$1);
